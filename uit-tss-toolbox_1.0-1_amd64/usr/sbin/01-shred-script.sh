...
function initialize {
    ...
    echo ""
    echo "Initializing UIT-TSS-SHRED by Cameron Raschke"
    echo ""
...
function intro {
	clear
	echo ""
	echo -e "Welcome to UIT-TSS-SHRED by Cameron Raschke."
	echo ""
...
function terminate {
	...
	echo ""
	echo "Shutting down automatically in 60 seconds"
	echo ""
