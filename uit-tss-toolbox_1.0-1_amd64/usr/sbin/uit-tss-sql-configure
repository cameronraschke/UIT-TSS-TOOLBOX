...
# 	device_type VARCHAR(150) NOT NULL DEFAULT '0', \
...
mysql --user="laptops" --password="UHouston!" --database="laptopDB" --execute="\
DROP TABLE serverstats;"

mysql --user="laptops" --password="UHouston!" --database="laptopDB" --execute="CREATE TABLE serverstats(\
	date VARCHAR(150) NOT NULL DEFAULT '$(date --iso)', \
	laptop_count VARCHAR(150) NOT NULL DEFAULT '0', \
	last_image_update VARCHAR(150) NOT NULL DEFAULT 'N/A', \
	all_jobs VARCHAR(150) NOT NULL DEFAULT '0', \
	clone_jobs VARCHAR(150) NOT NULL DEFAULT '0', \
	erase_jobs VARCHAR(150) NOT NULL DEFAULT '0', \
	all_avgtime VARCHAR(150) NOT NULL DEFAULT '0', \
