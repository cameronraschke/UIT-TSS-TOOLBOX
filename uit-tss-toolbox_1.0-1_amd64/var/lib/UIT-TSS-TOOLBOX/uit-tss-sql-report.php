...
<html>
    ...
    <body>
        <?php
            ...
            $sql = "SELECT * FROM clientstats WHERE NOT tagnumber = '000000' ORDER BY last_job_date DESC";
            $results = $conn->query($sql);
            while ($row = $results->fetch_array(MYSQLI_ASSOC)) {
                $tagnumber = $row['tagnumber'];
            ...
            while ($row = $results->fetch_array(MYSQLI_ASSOC)) {
                ...
                $clone_jobs = $row['clone_jobs'];
                $clone_avgtime = $row['clone_avgtime'];
                $nvme_erase_avgtime = $row['nvme_erase_avgtime'];
                $ssd_erase_avgtime = $row['ssd_erase_avgtime'];
