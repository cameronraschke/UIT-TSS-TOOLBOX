...
INSERT INTO static_disk_stats
    ...
    power_cycles)
VALUES 
    ('LITEON CV8-8E128-11 SATA 128GB','550','380','1500000','146',NULL,'0','70','m.2','ssd', FALSE,NULL,NULL),
    ('MTFDHBA256TCK-1AS1AABHA','3000','1600','2000000','75',NULL,NULL,'82','m.2','nvme', FALSE, NULL, NULL),
    ('SSDPEMKF256G8 NVMe INTEL 256GB','3210','1315','1600000','144',NULL,'0','70','m.2','nvme', FALSE,NULL,NULL),
    ('ST500LM034-2GH17A','160','160',NULL,'55','55','0','60','sata','hdd', TRUE,'7200','600000'),
    ('TOSHIBA MQ01ACF050',NULL,NULL,'600000', 125, 125,'5','55','sata','hdd', TRUE,'7200',NULL),
    ('WDC PC SN520 SDAPNUW-256G-1006','1300','1700','1752000','200',NULL,'0','70','m.2','nvme', FALSE,NULL,NULL),
    ('LITEON CV8-8E120-11 SATA 128GB','380','550','1500000','146',NULL,'0','70','m.2','ssd', FALSE,NULL,'50000'),
    ('LITEON CV3-8D512-11 SATA 512GB','490','540','1500000','250',NULL,NULL,NULL,'m.2','ssd', FALSE,NULL,NULL),
    ('TOSHIBA KSG60ZMV256G M.2 2280 256GB','340','550','1500000',NULL,NULL,'0','80','m.2','ssd', FALSE,NULL,NULL),
    ('TOSHIBA THNSNK256GVN8 M.2 2280 256GB', 388, 545, 1500000, 150, NULL, 0, 70, 'm.2', 'ssd', FALSE, NULL, NULL),
    ('PC SN740 NVMe WD 512GB','4000','5000','1750000','300',NULL,'0','85','m.2','nvme', FALSE,NULL,'3000'),
    ('SK hynix SC308 SATA 256GB',130,540,1500000,75,NULL,0,70,'m.2','ssd', FALSE,NULL,NULL),
    ('ST500LM000-1EJ162', 100, 100, NULL, 125, 125, 0, 60, 'sata', 'hdd', TRUE, 5400, 25000),
    ('ST500DM002-1SB10A', 100, 100, NULL, 125, 125, 0, 60, 'sata', 'hdd', TRUE, 5400, 25000),
    ('SanDisk SSD PLUS 1000GB', 350, 535, 26280, 100, NULL, NULL, NULL, 'sata', 'ssd', FALSE, NULL, NULL),
    ('WDC WD5000LPLX-75ZNTT1', NULL, NULL, 43800, 125, 125, 0, 60, 'sata', 'hdd', TRUE, 7200, NULL)
    ;
