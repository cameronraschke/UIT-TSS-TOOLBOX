...
?>
    ...
    <div class='row'>
      <div class='page-content'><h3>A checkmark (<span style='color:rgb(0, 255, 0)'>&#10004;</span>) means a client is currently online and ready for a job.</h3></div>
...
foreach ($tableArr as $key => $value1) {
  ...
  if ($value1["present_bool"] === 1 && ($value1["kernel_updated"] === 1 && $value1["bios_updated"] === 1)) {
    echo "<b><a href='tagnumber.php?tagnumber=" . htmlspecialchars($value1["tagnumber"], ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, "UTF-8", FALSE) . "' target='_blank'>" . htmlspecialchars($value1["tagnumber"], ENT_QUOTES | ENT_SUBSTITUTE | ENT_HTML401, "UTF-8", FALSE) . "</a></b> <span style='color:rgb(0, 255, 0)'>&#10004;</span>" . PHP_EOL;
