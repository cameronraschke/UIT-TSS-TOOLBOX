        ...
        if (!empty($_POST['tagnumber'])) {
            ...
            if (!empty($arr)) {
                foreach ($arr as $key => $value) {
                    ...
                    echo "<br>" . PHP_EOL;
                    dbSelectVal("SELECT department AS result FROM jobstats WHERE tagnumber = '" . $tagNum . "' ORDER BY time DESC LIMIT 1");
                    ...
                    echo "<br>" . PHP_EOL;
                    echo "<input type='text' id='note' name='note' value = '" . htmlspecialchars($value['note']) . "'>" . PHP_EOL;
                    echo "<br>" . PHP_EOL;
