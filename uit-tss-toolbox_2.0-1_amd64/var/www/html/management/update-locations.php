        ...
        if (!empty($_POST['tagnumber'])) {
            ...
            if (!empty($arr)) {
                foreach ($arr as $key => $value) {
                    ...
                    echo "<br>" . PHP_EOL;
                    echo "<label for='last_location'>Tag Number</label>" . PHP_EOL;
                    echo "<br>" . PHP_EOL;
                    echo "<input type='text' style='background-color:#888B8D;' id='last_location' name='last_location' value='" . $value['location'] . ", . " . $value['time'] . "' readonly>" . PHP_EOL;
                    echo "<br>" . PHP_EOL;
                ...
                echo "<br>" . PHP_EOL;
                echo "<label for='last_location'>Last entered location</label>" . PHP_EOL;
                echo "<br>" . PHP_EOL;
                echo "<input type='text' style='background-color:#888B8D;' id='last_location' name='last_location' value='" . $value['location'] . ", . " . $value['time'] . "' readonly>" . PHP_EOL;
                echo "<br>" . PHP_EOL;
                echo "<label for='department'>Department</label>" . PHP_EOL;
