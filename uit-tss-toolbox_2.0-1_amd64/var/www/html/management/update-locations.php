        ...
        if (!empty($_POST['tagnumber'])) {
            ...
            if (!empty($arr)) {
                foreach ($arr as $key => $value) {
                    ...
                    echo "<br>" . PHP_EOL;
                    echo "<label for='last_location'>Most Recent Location Entry (" . $value['time'] . ")</label>" . PHP_EOL;
                    echo "<br>" . PHP_EOL;
                    echo "<input type='text' style='background-color:#888B8D;' id='last_location' name='last_location' value='" . $value['location'] . "' readonly>" . PHP_EOL;
                    echo "<br>" . PHP_EOL;
