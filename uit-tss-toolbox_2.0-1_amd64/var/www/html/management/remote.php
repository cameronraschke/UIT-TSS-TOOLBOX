...
if (arrFilter($db->get()) === 0) {
    foreach ($db->get() as $key => $value) {
        ...
        echo "<div class='styled-table' style='width: auto; height:50%; overflow:auto; margin: 1% 1% 0% 1%;'>";
        echo "<table>";
