...
if (arrFilter($db->get()) === 0) {
    foreach ($db->get() as $key => $value) {
        ...
        if ($value["bios_updated"] === "Yes" && $value["kernel_updated"] === "Yes") {
