...
ALTER TABLE jobstats
    ...
    MODIFY COLUMN system_serial VARCHAR(24) DEFAULT NULL AFTER system_manufacturer,
    ...
    MODIFY COLUMN cpu_threads TINYINT DEFAULT NULL AFTER battery_manufacturedate,
