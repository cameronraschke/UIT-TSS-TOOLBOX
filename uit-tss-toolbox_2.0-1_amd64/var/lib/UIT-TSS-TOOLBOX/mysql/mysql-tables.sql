...
ALTER TABLE jobstats
    ...
    MODIFY COLUMN system_manufacturer VARCHAR(24) DEFAULT NULL AFTER department,
    MODIFY COLUMN system_model VARCHAR(20) DEFAULT NULL AFTER system_manufacturer,
    MODIFY COLUMN system_serial VARCHAR(24) DEFAULT NULL AFTER system_model,
    ...
    MODIFY COLUMN cpu_temp TINYINT DEFAULT NULL AFTER cpu_threads,
    MODIFY COLUMN motherboard_manufacturer VARCHAR(24) DEFAULT NULL AFTER cpu_temp,
...
VALUES 
    ...
    ('LITEON CV8-8E120-11 SATA 128GB','380','550','1500000','146',NULL,'0','70','m.2','sata','0',NULL,'50000'),
    ('LITEON CV3-8D512-11 SATA 512GB','490','540','1500000','250',NULL,NULL,NULL,'m.2','sata','0',NULL,NULL),
    ('TOSHIBA KSG60ZMV256G M.2 2280 256GB','340','550','1500000',NULL,NULL,'0','80','m.2','sata','0',NULL,NULL),
    ('TOSHIBA THNSNK256GVN8 M.2 2280 256GB','388','545','1500000',NULL,NULL,NULL,NULL,'m.2','sata','0',NULL,NULL)
    ;
...
CREATE TABLE IF NOT EXISTS remote (
    ...
    cpu_temp TINYINT DEFAULT NULL,
    disk_temp VARCHAR(10) DEFAULT NULL
);
...
ALTER TABLE remote
    ...
    MODIFY COLUMN disk_temp VARCHAR(10) DEFAULT NULL AFTER cpu_temp;
