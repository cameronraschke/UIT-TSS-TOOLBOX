...
ALTER TABLE jobstats
    ...
    MODIFY COLUMN disk_power_cycles MEDIUMINT DEFAULT NULL AFTER disk_power_on_hours,
...
ALTER TABLE IF EXISTS bios_stats (
    DROP PRIMARY KEY,
    ALTER COLUMN tagnumber VARCHAR(8) NOT NULL PRIMARY KEY FIRST,
    ALTER COLUMN time DATETIME(3) DEFAULT NULL AFTER tagnumber,
...
ALTER TABLE remote
    ...
    MODIFY COLUMN last_job_time DATETIME(3) DEFAULT NULL AFTER job_active,
